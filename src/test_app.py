...
It uses an in-memory SQLite database for faster testing.
"""
...
class TestApp(unittest.TestCase):
    def setUp(self):
        ...
        This method initializes the Flask app, configures it for testing,
        sets up an in-memory database, and adds some test data.
        """
        ...
        with self.app.app_context():
            ...
            self.app.add_url_rule(
                "/api/weather/stats", "get_weather_stats", get_weather_stats
            )
    ...
    def tearDown(self):
        ...
        This method removes the database session and drops all tables.
        """
        with self.app.app_context():
    ...
    def test_weather_filter(self):
        """Test filtering weather data by station_id"""
